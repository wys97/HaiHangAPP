...
export default class CreditSuccess extends React.Component {

  // 授信成功后 跳转的假页面
  static displayName = "creditSuccess";
  static propTypes = {};
  static defaultProps = {};
...
ReactDOM.render(<CreditSuccess />, document.getElementById("creditSuccess"));
